...
function play_game(){
  gameStatus="Start"
  document.getElementById("status").innerHTML= "Status: Your Game Is Loading."
}
...
function game(){
  ...
  if(gameConfig.status==='start'){
    document.getElementById("status").innerHTML= "Status: Your Game is Loaded."
    fill(0,0,0,150);
    ...
    textSize(40);
    textAlign(CENTER);
    text("Press the Play Button Above to Start and Play the Game.", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
